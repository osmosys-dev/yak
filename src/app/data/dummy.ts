...
export const MEDIA: any = {
  ...
  images: true,
  imagesCollection: ['local file #1 or url for dummy and svg for empty',
  'local file #2 or url for dummy', 'local file #3 or url for dummy'],
  },
  2: {
  id: 2,
  flashcardId: 2,
